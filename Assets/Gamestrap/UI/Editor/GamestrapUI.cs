...
namespace Gamestrap.UI
{
    ...
    public class GamestrapUI : EditorWindow
    {
        ...
        void SetBtnStyle()
        {
            ...
            btnStyle.normal.background = TextureLoader.PaletteNormal;
            btnStyle.active.background = TextureLoader.PalettePressed;
        }
        ...
        void SetBtnSelectedStyle()
        {
            ...
            btnSelectedStyle.normal.background = TextureLoader.PaletteSelected;
        }
        ...
        public void AssignColorsToSelection(GameObject gameObject, ColorSet colorSet)
        {
            ...
            else if (recursiveLevel == 1)
            {
                ...
                else if (gameObject.GetComponent<UnityEngine.UI.Text>())
                {
                    ...
                    text.color = new Color(colorSet.normal.r, colorSet.normal.g, colorSet.normal.b, colorSet.normal.a);
