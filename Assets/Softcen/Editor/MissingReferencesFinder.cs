...
public class MissingReferencesFinder : MonoBehaviour 
{
	...
	{
        Debug.Log("Start Search in scene...");
        ...
        Debug.Log("Search in scene DONE!");
    }
	...
	{
        Debug.Log("Start Search in all scenes...");
        ...
        Debug.Log("Start Search in all scenes DONE!");
    }
    ...
    private static void FindMissingReferences(string context, GameObject[] objects)
	{
		foreach (var go in objects)
		{
            ...
            if (btn != null)
            {
                ...
                {
                    Object btnObj = btn.onClick.GetPersistentTarget(i);
                    if (btnObj == null)
                    {
                        Debug.LogError("Missing Button onClick reference in GO: " + GetFullPath(go), go);
                        break;
                    }
                }
            }
